...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Add Trip Category</h1>

        <!--Add Trip Category-->
        {!! Form::open(['method'=>'POST','action'=>'Admin\AdminTripCategoryController@store', 'files'=>'true']) !!}
    ...
    {!! Form::submit('Add Category',['class'=>'btn btn-primary float-right']) !!}
    {!! Form::close() !!}
    <!--End of Add Trip Category-->
